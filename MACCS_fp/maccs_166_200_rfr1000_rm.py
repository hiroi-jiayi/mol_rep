...
def rfr_prediction(folder):
    ...
    for obj in files:
        ...
        maccs_df[obj] = maccs_df[obj][[i for i in maccs_df[obj] if maccs_df[obj][i].nunique()>1]]
    ...
    print(df)
    df.to_csv('maccs_166_200_rfr1000_rm.csv',index=False)
